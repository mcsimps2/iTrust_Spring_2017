...
public class MicrosoftBandImportFactory extends FitnessImportFactory
{
	 ...
	 * @throws DBException 
	 */
	public MicrosoftBandImportFactory() throws DBException
	{
	 ...
	 */
	public MicrosoftBandImportFactory(DataSource ds)
	{
		fisql = new FitnessInfoMySQL(ds);
	}
	
	/**
	 * Parses the input for Microsoft Band fitness info and inserts the info for each date into the fitness database,
	...
	{
		//The correct headers
		String[] correctHeader = {"Date", "Steps", "Calories", "HR_Lowest", "HR_Highest", "HR_Average", "Total_Miles_Moved", "Active_Hours", "Floors_Climbed", "UV_Exposure_Minutes"};
	...
	{	
		...
		//Now check all other columns except the seventh (colNum = 6 since 0-indexed, distance) are non-negative ints
		...
		ArrayList<String> distances = getColumn(data, 6);
