...
public class ChildbirthVisitTest
{
	...
	{
		ChildbirthVisit cv1 = new ChildbirthVisit(1L, DeliveryMethod.VAGINAL_DELIVERY, VisitType.PRE_SCHEDULED_APPOINTMENT, 5, 4, 3, 2, 1);
		ChildbirthVisit cv2 = new ChildbirthVisit(1L, DeliveryMethod.VAGINAL_DELIVERY, VisitType.PRE_SCHEDULED_APPOINTMENT, 5, 4, 3, 2, 1);
