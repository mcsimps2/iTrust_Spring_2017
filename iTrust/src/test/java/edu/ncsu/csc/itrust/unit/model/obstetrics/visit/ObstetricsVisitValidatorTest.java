...
public class ObstetricsVisitValidatorTest {
	...
	public void testValidateUpdate() {
		...
		Arrays.fill(b1, (byte)0);
		try {
			ObstetricsVisit goodObj = new ObstetricsVisit(new Long(2), new Integer(13), new Integer(54), new Integer(3), new Boolean(true), new SerialBlob(b1));
		...
		try {
			ObstetricsVisit goodObj2 = new ObstetricsVisit(new Long(2), new Integer(13), null, null, null, new SerialBlob(b1));
