...
CREATE TABLE patients(
	...
	obstetricsCareEligibility BOOLEAN default FALSE,
	PRIMARY KEY (MID)
) ENGINE=MyISAM;
...
(
	...
	dateOfData DATE,
	steps BIGINT UNSIGNED,
	caloriesBurned BIGINT UNSIGNED,
	distance DOUBLE UNSIGNED,
	floors BIGINT UNSIGNED,
	caloriesActive BIGINT UNSIGNED,
	minutesSedentary BIGINT UNSIGNED,
	minutesFairlyActive BIGINT UNSIGNED,
	minutesLightlyActive BIGINT UNSIGNED,
	minutesVeryActive BIGINT UNSIGNED,
	heartRateLow BIGINT UNSIGNED,
	heartRateHigh BIGINT UNSIGNED,
	heartRateAvg BIGINT UNSIGNED,
...
(
	...
	timeEstimated BOOLEAN NOT NULL,
	PRIMARY KEY (id),
	FOREIGN KEY	(officeVisitID)	REFERENCES officeVisit(visitID)
) ENGINE=MyISAM;