...
<form id="editForm" action="editPatient.jsp" method="post"><input type="hidden" name="formIsFilled" value="true">
...
<div align=center>
	...
	<input type="submit" name="action" style="font-size: 16pt; font-weight: bold;" value="Edit Patient Record" form="editForm">
	<% } else { %>
...
<table class="fTable" align=center style="width: 350px;">
	...
	<tr>
		<td class="subHeaderVertical"><img src="${pageContext.request.contextPath}/ImageServlet?pid=${pid}" style="max-width: 60px; padding-right: 10px;">
		<form action="upload" method="post" enctype="multipart/form-data" style="display: inline-block; vertical-align: middle;">
